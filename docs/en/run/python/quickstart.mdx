...
- Familiarity with [runtime choice](/en/get-started/platforms#2-pick-a-runtime) — `qairt` for AI Hub bundles, `llama_cpp` for any GGUF.
...
<CardGroup cols={2}>
  ...
  <Card title="Models" href="/en/models/supported" icon="cube">
    Supported models, GGUF on Hugging Face, and self-converted QAIRT bundles.
  </Card>
</CardGroup>
