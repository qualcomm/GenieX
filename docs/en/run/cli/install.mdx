...
<Tabs>
  <Tab title="Windows ARM64">
    ...
    - Snapdragon X-series device (X Elite or X2 Elite). See [Supported platforms](/en/get-started/platforms).
  ...
  <Tab title="Linux ARM64 (Native)">
    ...
    - Linux ARM64 host.
    - Qualcomm IoT device — see [Supported platforms](/en/get-started/platforms).
