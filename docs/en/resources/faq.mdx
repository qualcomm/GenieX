...
<AccordionGroup>
  <Accordion title="What's the difference between llama.cpp and QAIRT?">
    ...
    See [Platforms & runtimes](/en/get-started/platforms#2-pick-a-runtime).
  </Accordion>
  ...
  <Accordion title="Which quantization should I pick?">
    For llama.cpp on Snapdragon NPU: **`Q4_0`**. It has the best Hexagon NPU support. QAIRT bundles are pre-quantized — no choice. See [Quantization & device placement](/en/models/supported#quantization--device-placement).
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Where's the supported models list?">
    [Models](/en/models/supported) — split by runtime (QAIRT, llama.cpp).
  </Accordion>
</AccordionGroup>
