...
<AccordionGroup>
  <Accordion title="How do I install Python on a Linux ARM64 device?" id="how-do-i-install-python-on-a-linux-arm64-device">
    QDC devices (Qualcomm embedded Linux / Yocto) ship with Python pre-installed. If your device does not have Python, use one of these methods:

    **Option 1 — [Miniconda](https://docs.anaconda.com/miniconda/) (recommended)**
  ...
  <Accordion title="Is Miniconda supported on Windows ARM64?">
    No. There is currently no native Windows ARM64 Miniconda installer. On Windows ARM64, download the official [Python ARM64 installer](https://www.python.org/ftp/python/3.13.3/python-3.13.3-arm64.exe) from python.org instead — see [Python Install](/en/run/python/install).
  </Accordion>
</AccordionGroup>
