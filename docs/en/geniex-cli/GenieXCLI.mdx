...
For QAIRT plugin model, no quantization precision selection is needed. For llama.cpp plugin model, after running `geniex pull <model-name>`, the CLI will prompt:
