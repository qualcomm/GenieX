...
<Note>**Qualcomm AI Engine Direct** is the official name of what is also known as the *Qualcomm AI Engine Direct SDK*, *Qualcomm AI Runtime*, and historically *QAIRT*. Throughout these docs we use the official name; the lowercase `qairt` code identifier (plugin id, `device_map`) is unchanged.</Note>
