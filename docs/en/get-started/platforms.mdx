...
<Note>**Qualcomm AI Engine Direct** (also known as the *Qualcomm AI Engine Direct SDK*, *Qualcomm AI Runtime*, and historically *QAIRT*) is the official name. Throughout these docs we use the official name; the lowercase `qairt` code identifier (plugin id, `device_map`) is unchanged.</Note>
